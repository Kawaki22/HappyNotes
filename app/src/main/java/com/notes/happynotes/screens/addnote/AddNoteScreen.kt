...
fun AddNoteScreen(navController: NavController, viewModel: HomeScreenViewModel = hiltViewModel()) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize(),
        ...
        Column(modifier = Modifier
            ...
            TextField(modifier = Modifier.fillMaxWidth().height(60.dp).focusRequester(focusReq), value = title.value, onValueChange = { title.value = it },
            ...
            TextField(modifier = Modifier.fillMaxWidth().fillMaxHeight(0.40f).focusRequester(focusReqBody), value = body.value, onValueChange = { body.value = it },
